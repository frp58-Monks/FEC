...
// const productDetails = JSON.parse(JSONProductDetails);
const productDetais = { id: 40344, campus: "hr-rfp", name: "Camo Onesie", slogan: "Blend in to your crowd", description: "The So Fatigues will wake you up and fit you in. This high energy camo will have you blending in to even the wildest surroundings.", category: "Jackets", default_price: "140.00", created_at: "2021-08-13T14:38:44.509Z", updated_at: "2021-08-13T14:38:44.509Z", features: Array [Object { feature: "Fabric", value: "Canvas" }, Object { feature: "Buttons", value: "Brass" }] }


//product styles
let JSONProductStyles = {
  "product_id": "40344",
  "results": [
      {
          "style_id": 240500,
...
const productStyles = JSON.parse(JSONProductStyles);
...
let JSONReviewstars = {
  ...
  "characteristics": {
      "Fit": {
          "id": 135219,
          "value": "2.8378378378378378"
      },
      "Length": {
          "id": 135220,
          "value": "2.9189189189189189"
      },
      "Comfort": {
          "id": 135221,
          "value": "3.2688172043010753"
      },
      "Quality": {
          "id": 135222,
          "value": "3.4615384615384615"
      }
  }
}
const reviewStars = JSON.parse(JSONReviewstars);
